...
${Plot}           Alice tem a missão de desativar a rainha vermelha na colmeia pq alguem jogou um virus e deu ruim

*** Keywords ***
#### Steps
Dado que estou logado com credenciais válidas
    Input Text      ${INPUT_EMAIL}      albert@ninjaplus.com
    Input Text      ${INPUT_PASS}       teste123
